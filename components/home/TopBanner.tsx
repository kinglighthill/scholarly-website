  ...
  return (
    <Box as='section' bgColor='brand.nearWhite' className={classes.banner_container}>    
      <Flex justify='space-between' wrap={{base: 'wrap', lg: 'nowrap'}}>
        <VStack spacing={8} align='start' flexBasis={{base: '100%', md: '80%', lg: '44%'}} pb={{lg: 5}}>
          <Box>
            <Box display={{base: 'none', md: 'block'}}>
              <Image src={green_pattern} alt='' />
            </Box>
            <Text display={['none', 'block']} fontWeight='black' fontSize={{base: '5xl', lg: 40, xl: '5xl'}} lineHeight='120.5%'>
