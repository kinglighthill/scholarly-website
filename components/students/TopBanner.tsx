    ...
    <Box as='section' pl={[0, "55px", "120px", "55px", "120px"]} pr={{'2xl': "120px"}}>    
      <Flex pos='relative' justify='space-between' flexWrap={{base: 'wrap', lg: 'nowrap'}} className='responsive_1440px'>
        ...
        <Box pos='relative' display={['block', 'none', 'none', 'block']} flexBasis={{base: '100%', lg: '55%', xl: '63%'}} h={{base: '340px', lg: 'auto'}} bgImage='/female_student_studying_with_laptop.webp' bgSize='cover' bgRepeat='no-repeat'>
          <Label labelText='Jamb Practice' labelIcon={<BoxWithJambIcon/>} boxProps={{top: ['10%','38%'], left: ['5%','15%']}} />
          <Label labelText='WAEC Questions' labelIcon={<BoxWithWaecIcon/>} boxProps={{bottom: '25%', right: '22%'}} />
        </Box>
      </Flex>
