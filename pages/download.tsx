...
const Download: NextPage = (props: InferGetStaticPropsType<typeof getStaticProps>) => {
  const { data } = props;

  return (
    <Page title='Scholarly Apps - 30+ Scholarly Apps' description='Over 30+ offline apps available for JAMB, WAEC, Post UTME, NECO, BECE exams, etc.'
      keywords={[
