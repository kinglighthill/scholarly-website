...
const About: NextPage = () => {
  return (
    <Page title="About Us | Scholarly Africa" description="Scholarly provides all the tools and resources required by students to learn better and make excellent grades. We have so far published over 30 exam preparatory apps for android, iOS and Desktop."
      keywords={[
        "About Scholarly", "Scholarly Africa", "Scholarly Nigeria Limited", "Scholarly's mission", "Scholarly's vision", "Scholarly's goal", "Scholarly's roadmap", "The future of Scholarly"
      ]}
    >
      <Box as="section" px={[5, "10%", 10, 10, "10%"]} pt={{base: 14, md: "104px"}} pb="104px" bg="brand.lime.700" borderBottom="1px solid" borderColor="brand.yellow">
        <Flex wrap={{base: "wrap", md: "nowrap"}} className='responsive_1440px'>
